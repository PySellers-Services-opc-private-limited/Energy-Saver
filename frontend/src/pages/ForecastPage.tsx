    ...
    <div>
      ...
      {data && (
        <div className="px-6 pt-6 pb-8">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 h-80">
            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody>
                {data.forecasts.slice(0, 12).map((p) => (
                  <tr key={p.timestamp} className="border-b border-gray-900 hover:bg-gray-900/50">
                    <td className="py-2 pr-6 text-gray-400">
                      {new Date(p.timestamp).toLocaleString()}
                    </td>
                    <td className="py-2 pr-6 text-right text-brand-400 font-mono">
