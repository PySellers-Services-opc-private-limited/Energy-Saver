...
import { Zap, Sun, AlertTriangle, IndianRupee, Users, TrendingUp, Wifi } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="px-6 pt-4 flex items-center gap-2 text-xs">
        ...
        <span className={connected ? 'text-brand-400' : 'text-red-400'}>
          {connected ? 'Live stream connected' : 'Reconnecting…'}
        </span>
        {reading && (
          <span className="text-gray-500 ml-2">
            Device: <span className="text-gray-300">{reading.device_id}</span>
          </span>
        )}
      </div>
      ...
      <div className="px-6 pt-8 pb-8">
        <h2 className="text-sm font-semibold text-gray-300 mb-4">Live Consumption · Last 60 s</h2>
