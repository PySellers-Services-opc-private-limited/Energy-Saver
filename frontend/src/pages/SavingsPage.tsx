  ...
  return (
    <div>
      ...
      <div className="px-6 pt-5 pb-4">
          <div className="bg-white border border-sky-100 rounded-xl p-5 flex flex-wrap gap-6 items-end shadow-sm">
          <div>
            <label className="block text-xs text-gray-400 mb-1">
              Baseline: <span className="text-gray-800 font-semibold">{kwh} kWh/day</span>
            </label>
            <input
          ...
          <div>
            <label className="block text-xs text-gray-400 mb-1">
              Tariff: <span className="text-gray-800 font-semibold">₹{tariff.toFixed(2)}/kWh</span>
            </label>
            <input
