...
class ModelConfig:
    ...
    forecasting_path:  str = "ml_models/finetuned/forecasting_progressive.keras"
    anomaly_path:      str = "ml_models/finetuned/anomaly_feature_extraction.keras"
    occupancy_path:    str = "ml_models/finetuned/occupancy_progressive.keras"
    hvac_path:         str = "ml_models/finetuned/hvac_model.keras"
    solar_path:        str = "ml_models/finetuned/solar_progressive.keras"
    backbone_path:     str = "ml_models/pretrained/backbone_weights.weights.h5"
