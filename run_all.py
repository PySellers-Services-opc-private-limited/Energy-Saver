...
STEPS = [
    ...
    ("Step 2: Energy Forecasting (LSTM)",   "models/model_1_forecasting.py"),
    ("Step 3: Anomaly Detection",           "models/model_2_anomaly.py"),
    ("Step 4: Occupancy Prediction",        "models/model_3_occupancy.py"),
    ("Step 5: HVAC Optimization",           "models/model_4_hvac.py"),
    ("Step 6: Appliance Fingerprinting",    "models/model_5_appliance_fingerprinting.py"),
    ("Step 7: Solar Generation Forecast",   "models/model_6_solar_forecast.py"),
    ("Step 8: EV Charging Optimizer",       "models/model_7_ev_optimizer.py"),
    ("Step 9: Monthly Bill Predictor",      "models/model_8_bill_predictor.py"),
]
