...
PIPELINE_CONFIG = {
    ...
    # AI Models
    "models": {
        "forecasting_path":    "models/finetuned/forecasting_progressive.keras",
        "anomaly_path":        "models/finetuned/anomaly_feature_extraction.keras",
        "occupancy_path":      "models/finetuned/occupancy_progressive.keras",
        "hvac_path":           "models/finetuned/hvac_model.keras",
        "solar_path":          "models/finetuned/solar_progressive.keras",
        "window_size":         48,
